 ...
 */
function SVGTimelineFactory(canvas, xOffset, yOffset, timelineSize, tickInterval, hours){

    this._snap = Snap("#" + canvas);
    this._snap.clear();
 ...
 */
SVGTimelineFactory.prototype.drawTimelineAxis = function(timeline){
 ...
 */
SVGTimelineFactory.prototype.hourFloatToTime = function(f){
...
SVGTimelineFactory.prototype.hourFloatToDayTime = function(f){
    var hours = Math.floor(f);
    var hrs = hours % 24;
    var mins = Math.floor((f - hours)*60);
...
SVGTimelineFactory.prototype.hourToPixelPosition = function(t, size, offset, hours){
    var h = t/hours;
    return h * size  + offset;
}

SVGTimelineFactory.prototype.pixelsToHours = function(p, size, offset, hours){
 ...
 */
SVGTimelineFactory.prototype.renderEvent = function(event){
...
SVGTimelineFactory.prototype.drawSliders = function(timeline){
 ...
 */
SVGTimelineFactory.prototype.renderTimeline = function(timeline){
